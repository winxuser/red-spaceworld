...
MonGenderRatios:
	...
	db FEMALE_75_PERCENT ; KURUSU
	db FEMALE_75_PERCENT ; AKUA
	db NO_GENDER         ; FARFETCHD
	db SAME_BOTH_GENDERS ; VENONAT
	db SAME_BOTH_GENDERS ; DRAGONITE
	db FEMALE_75_PERCENT ; AKUERIA
	...
	db SAME_BOTH_GENDERS ; MISSINGNO
	db SAME_BOTH_GENDERS ; MISSINGNO
	db SAME_BOTH_GENDERS ; MISSINGNO
	...
	db FEMALE_75_PERCENT ; MISSINGNO
