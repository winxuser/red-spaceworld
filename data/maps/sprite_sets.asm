...
MapSpriteSets:
	table_width 1
	db SPRITESET_PALLET_VIRIDIAN ; SILENT_HILL
	db SPRITESET_PALLET_VIRIDIAN ; OLD_CITY
	db SPRITESET_PEWTER_CERULEAN ; WEST_CITY
	db SPRITESET_PEWTER_CERULEAN ; BIRDON
	db SPRITESET_LAVENDER        ; FONT
	db SPRITESET_VERMILION       ; SOUTH_CITY
	db SPRITESET_CELADON         ; HIGH_TECH
	db SPRITESET_FUCHSIA         ; NEW_TYPE
	db SPRITESET_PALLET_VIRIDIAN ; PRINCE
	db SPRITESET_INDIGO          ; KANTO
	db SPRITESET_SAFFRON         ; STAND
	db SPRITESET_PALLET_VIRIDIAN ; BLUE_FOREST UNUSED_MAP_0B
	db SPRITESET_PALLET_VIRIDIAN ; NORTH_CITY UNUSED_MAP_0B
	db SPRITESET_PALLET_VIRIDIAN ; SOUTH_CITY UNUSED_MAP_0B
	db SPRITESET_PALLET_VIRIDIAN ; MT_FUJI UNUSED_MAP_0B
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_1
	db SPRITESET_PALLET_VIRIDIAN ; ROUTE_1_P2
	...
	db SPRITESET_PEWTER_CERULEAN ; ROUTE_26
	db SPRITESET_PEWTER_CERULEAN ; ROUTE_29
	db SPRITESET_PEWTER_CERULEAN ; ROUTE_30
