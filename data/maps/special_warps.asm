...
.Birdon:         fly_warp BIRDON,          15,  5
.Font:           fly_warp FONT,             3, 13
.SouthCity:      fly_warp SOUTH_CITY,      33, 15
.HighTech:       fly_warp HIGH_TECH,       31, 11
.NewType:        fly_warp NEW_TYPE,         7, 9
.Prince:         fly_warp PRINCE,          11, 12
.Kanto:          fly_warp KANTO,           13,  5
.Stand:          fly_warp STAND,           33, 21
.BlueForest:     fly_warp BLUE_FOREST,     13, 19
