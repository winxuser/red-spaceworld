...
FuchsiaCity_Object:
	...
	bg_event 32,  7, TEXT_FUCHSIACITY_CHANSEY_SIGN
	bg_event 26,  7, TEXT_FUCHSIACITY_VOLTORB_SIGN
	bg_event 12,  7, TEXT_FUCHSIACITY_KANGASKHAN_SIGN
	bg_event 30, 13, TEXT_FUCHSIACITY_SLOWPOKE_SIGN
	bg_event 13, 15, TEXT_FUCHSIACITY_LAPRAS_SIGN
	bg_event  6,  7, TEXT_FUCHSIACITY_FOSSIL_SIGN
