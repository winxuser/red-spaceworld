...
OaksLab_Object:
	...
	object_event  4, 15, SPRITE_OAK, STAY, UP, TEXT_OAKSLAB_OAK2
	object_event  1, 11, SPRITE_GIRL, STAY, RIGHT, TEXT_OAKSLAB_GIRL
	object_event  6, 12, SPRITE_SCIENTIST, STAY, NONE, TEXT_OAKSLAB_SCIENTIST1
	object_event  0,  5, SPRITE_SCIENTIST, STAY, NONE, TEXT_OAKSLAB_SCIENTIST2
