...
OaksLab_Object:
	...
	object_event  6,  6, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_HONOGUMA_POKE_BALL
	object_event  7,  6, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_KURUSU_POKE_BALL
	object_event  8,  6, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_HAPPA_POKE_BALL
