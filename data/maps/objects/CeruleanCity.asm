...
CeruleanCity_Object:
	...
	warp_event 27, 19, CERULEAN_GYM, 1
	warp_event 13, 25, BIKE_SHOP, 1
	warp_event 25, 24, CERULEAN_MART, 1
	warp_event  3, 11, CERULEAN_CAVE_1F, 1
	warp_event 27,  9, CERULEAN_TRASHED_HOUSE, 3
	warp_event  9, 11, CERULEAN_BADGE_HOUSE, 2
	warp_event  9,  9, CERULEAN_BADGE_HOUSE, 1

	def_bg_events
	bg_event 22, 19, TEXT_CERULEANCITY_SIGN
	bg_event 16, 29, TEXT_CERULEANCITY_TRAINER_TIPS
	bg_event 26, 24, TEXT_CERULEANCITY_MART_SIGN
	bg_event 20, 17, TEXT_CERULEANCITY_POKECENTER_SIGN
	bg_event 10, 25, TEXT_CERULEANCITY_BIKESHOP_SIGN
	...
	object_event 28, 20, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_CERULEANCITY_COOLTRAINER_M
	...
	object_event  3, 12, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_CERULEANCITY_SUPER_NERD3
