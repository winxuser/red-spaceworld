	...
	const_export VIRIDIANFOREST_BERRY_TREE1
	const_export VIRIDIANFOREST_BERRY_TREE2
...
ViridianForest_Object:
	...
	object_event 14, 16, SPRITE_BERRY_TREE, STAY, DOWN, TEXT_VIRIDIANFOREST_BERRY_TREE1
	object_event 19, 30, SPRITE_BERRY_TREE, STAY, DOWN, TEXT_VIRIDIANFOREST_BERRY_TREE2
