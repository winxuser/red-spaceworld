...
LavenderTown_Object:
	...
	def_warp_events
	warp_event  3,  4, LAVENDER_POKECENTER, 1
	warp_event 15,  5, POKEMON_TOWER_1F, 1
	warp_event  7,  9, MR_FUJIS_HOUSE, 1
	warp_event 15, 12, LAVENDER_MART, 1
	...
	bg_event 16, 12, TEXT_LAVENDERTOWN_MART_SIGN
	bg_event  4,  4, TEXT_LAVENDERTOWN_POKECENTER_SIGN
