...
VermilionCity_Object:
	...
	warp_event  9, 12, POKEMON_FAN_CLUB, 1
	warp_event 23, 12, VERMILION_MART, 1
	warp_event 11, 19, VERMILION_GYM, 1
	warp_event 23, 19, VERMILION_PIDGEY_HOUSE, 1
	warp_event 18, 31, VERMILION_DOCK, 1
	warp_event 19, 31, VERMILION_DOCK, 1
	warp_event 15, 12, VERMILION_TRADE_HOUSE, 1
	warp_event  7,  3, VERMILION_OLD_ROD_HOUSE, 1

	def_bg_events
	bg_event 26,  3, TEXT_VERMILIONCITY_SIGN
	bg_event 36, 13, TEXT_VERMILIONCITY_NOTICE_SIGN
	bg_event 24, 12, TEXT_VERMILIONCITY_MART_SIGN
	bg_event 12,  3, TEXT_VERMILIONCITY_POKECENTER_SIGN
	bg_event  6, 12, TEXT_VERMILIONCITY_POKEMON_FAN_CLUB_SIGN
	bg_event  6, 19, TEXT_VERMILIONCITY_GYM_SIGN
