...
; Route 22
	...
	db $FF, 9, PIDGEY, 8, KURUSU, 0
	db $FF, 9, PIDGEY, 8, HAPPA, 0
	db $FF, 9, PIDGEY, 8, HONOGUMA, 0
; Cerulean City
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, SQUIRTLE, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, BULBASAUR, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, CHARMANDER, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, KURUSU, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, HAPPA, 0
	db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, HONOGUMA, 0
...
; Unused
	...
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, AKUERIA, 70, GYARADOS, 0
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, HANARYU, 70, GYARADOS, 0
	db $FF, 66, TAUROS, 67, EXEGGUTOR, 68, ARCANINE, 69, DAINABEA, 70, GYARADOS, 0
...
; SS Anne 2F
	...
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, AKUA, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, HANAMOGURA, 0
	db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, BORUBEA, 0
; Pokémon Tower 2F
	...
	db $FF, 25, PIDGEOTTO, 23, GROWLITHE, 22, EXEGGCUTE, 20, KADABRA, 25, AKUA, 0
	db $FF, 25, PIDGEOTTO, 23, GYARADOS, 22, GROWLITHE, 20, KADABRA, 25, HANAMOGURA, 0
	db $FF, 25, PIDGEOTTO, 23, EXEGGCUTE, 22, GYARADOS, 20, KADABRA, 25, BORUBEA, 0
; Silph Co. 7F
	...
	db $FF, 37, PIDGEOT, 38, GROWLITHE, 35, EXEGGCUTE, 35, ALAKAZAM, 40, AKUERIA, 0
	db $FF, 37, PIDGEOT, 38, GYARADOS, 35, GROWLITHE, 35, ALAKAZAM, 40, HANARYU, 0
	db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, ALAKAZAM, 40, DAINABEA, 0
; Route 22
	...
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GROWLITHE, 47, EXEGGCUTE, 50, ALAKAZAM, 53, AKUERIA, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GYARADOS, 47, GROWLITHE, 50, ALAKAZAM, 53, HANARYU, 0
	db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, DAINABEA, 0
...
Rival3Data:
	...
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, ARCANINE, 63, EXEGGUTOR, 65, AKUERIA, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, ARCANINE, 65, HANARYU, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, DAINABEA, 0
