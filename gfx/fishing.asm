...
GreenFishingTilesFront: INCBIN "gfx/overworld/kris_fish_front.2bpp"
GreenFishingTilesBack:  INCBIN "gfx/overworld/kris_fish_back.2bpp"
GreenFishingTilesSide:  INCBIN "gfx/overworld/kris_fish_side.2bpp"
