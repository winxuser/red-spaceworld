...
; Silent Hill events
	...
	const_skip 2
	const EVENT_SILENT_AFTER_GETTING_POKEBALLS
	const_skip 17
	...
	const EVENT_SILENT_AFTER_GETTING_POKEBALLS_2
	const EVENT_OAK_APPEARED_IN_SILENT
...
;	const EVENT_GOT_TM42
	...
	const EVENT_BEAT_MIKON
	const EVENT_BEAT_OLD_GYM_TRAINER_0
	const_skip 31
;	const EVENT_GOT_TM27

;	const EVENT_BEAT_OLDCITY_GYM_MIKON
...
; Silent Hills events
	const_next $560
	const_skip 2
	const EVENT_BEAT_SILENT_HILLS_TRAINER_0
	const EVENT_BEAT_SILENT_HILLS_TRAINER_1
	const EVENT_BEAT_SILENT_HILLS_TRAINER_2
